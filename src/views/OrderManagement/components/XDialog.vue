...
let props = defineProps(["addOrderDialogFormVisible"]);
let dialogFormVisible = ref(props.addOrderDialogFormVisible);
...
watch(
  () => props,
  (newVal) => {
    dialogFormVisible.value = newVal.addOrderDialogFormVisible;
    // console.log(newVal);
  },
  { deep: true }
);
