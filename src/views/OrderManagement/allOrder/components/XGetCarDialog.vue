...
import XOrderDetail from "../../components/XOrderDetail.vue";
import { reactive, ref, watch, defineEmits } from "vue";
import { useStore } from "vuex";
const store = useStore();
const props = defineProps(["getCarDialogFormVisible"]);
const emits = defineEmits(["changeDialogFormVisible"]);

let dialogFormVisible = ref(props.getCarDialogFormVisible);
/* 
...
function handleClose() {
  store.dispatch('orderManagement/changeGetCarDialogVisible',false);
}
watch(
  () => props.getCarDialogFormVisible,
  (newVal) => {
