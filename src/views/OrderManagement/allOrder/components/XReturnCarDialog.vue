...
const props=defineProps(['returnCarDialogFormVisible'])
const emits=defineEmits(['changeDialogFormVisible'])

let dialogFormVisible = ref(props.returnCarDialogFormVisible)
/* 
...
watch(()=>props.returnCarDialogFormVisible,(newVal)=>{
